...
export function OrderViewClient({
  ...
  const [addressLine1, setAddressLine1] = useState<string>(
    initialOrder.shipping_address?.address_1 || ''
  );
  ...
  const [orderDate, setOrderDate] = useState<Date>(
    new Date(initialOrder.created_at)
  );
  ...
  const assignCustomer = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `Assigned to ${customerEmail}`,
      });
    } catch (error) {
      ...
      toast({
        title: 'Update failed',
        description: 'Unable to assign customer.',
        variant: 'destructive',
      });
    } finally {
      setIsLoading(false);
  ...
  const assignAddress = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `New address: ${addressLine1}`,
      });
    } catch (error) {
  ...
  const capturePayment = async () => {
    ...
    try {
      // Replace with your actual API call:
      //
      // await medusaClient.admin.paymentCollections.capture(
      ...
      toast({
        ...
        description: 'Unable to capture payment.',
        variant: 'destructive',
      });
    } finally {
      setIsLoading(false);
  ...
  const allocateStock = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: 'Inventory has been allocated.',
      });
    } catch (error) {
      ...
      toast({
        ...
        description: 'Unable to allocate inventory.',
        variant: 'destructive',
      });
    } finally {
      setIsLoading(false);
  ...
  const fulfillOrder = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: 'Order is now fulfilled.',
      });
    } catch (error) {
      ...
      toast({
        ...
        description: 'Unable to fulfill order.',
        variant: 'destructive',
      });
    } finally {
      setIsLoading(false);
  ...
  const updateOrderDate = async () => {
    ...
    try {
      ...
      setOrder((prev) => ({
        ...prev,
        created_at: orderDate.toISOString(),
        created_date: orderDate.toLocaleDateString(),
      }));

      toast({
        title: 'Order date updated',
        description: `New date: ${format(orderDate, 'PPP')}`,
      });
    } catch (error) {
      ...
      toast({
        title: 'Update failed',
        description: 'Unable to update order date.',
        variant: 'destructive',
      });
    } finally {
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              ...
              <AlertDialogFooter>
                ...
                <AlertDialogAction onClick={allocateStock}>
                  Confirm
                </AlertDialogAction>
              </AlertDialogFooter>
            </AlertDialogContent>
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              ...
              <AlertDialogFooter>
                ...
                <AlertDialogAction onClick={fulfillOrder}>
                  Confirm
                </AlertDialogAction>
              </AlertDialogFooter>
            </AlertDialogContent>
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                ...
                <AlertDialogFooter>
                  ...
                  <AlertDialogAction onClick={capturePayment}>
                    Confirm
                  </AlertDialogAction>
                </AlertDialogFooter>
              </AlertDialogContent>
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button
                ...
                className="h-9 min-w-[220px] justify-start text-left font-normal"
              >
                {orderDate ? (
