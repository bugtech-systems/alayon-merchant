...
export default function AIAssistantUI() {
  ...
  function sendMessage(convId, content, response) {
  ...
  return (
    <div className=" w-full bg-zinc-50 text-zinc-900 dark:bg-zinc-950 dark:text-zinc-100">
      ...
      <div className="mx-auto flex h-[calc(100vh-0px)] py-5">
            {!sidebarOpen && (
        <button
          onClick={() => setSidebarOpen(!sidebarOpen)}
          className="fixed right-4 top-4 z-50 rounded-full bg-white p-2 shadow-lg ring-1 ring-zinc-200 transition hover:bg-zinc-50 dark:bg-zinc-800 dark:ring-zinc-700 dark:hover:bg-zinc-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 md:hidden"
       ...
       <Sidebar
        ...
        <main className="relative flex min-w-0 flex-1 flex-col">
          ...
          <ChatPane
            ...
            onSend={(content, response) => selected && sendMessage(selected.id, content, response)}
            onEditMessage={(id, messageId, newContent) => selected && editMessage(id, messageId, newContent)}
